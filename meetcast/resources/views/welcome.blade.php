...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    class="antialiased">
        <div class="realtive min-h-screen bg-black/40 flex flex-col">
            @if (Route::has('login'))
            ...
            <center class="m-auto flex flex-col gap-y-10">
                ...
                <a class="rounded-3xl bg-gradient-to-r from-violet-500 via-pink-500 to-red-500 text-white text-xl font-bold px-8 py-2.5 max-w-fit mx-auto" href="{{route('register')}}">
                    Create account
                </a>
            </center>
        </div>
