<div id="meetcast" class="m-auto md:p-10 w-full h-full relative">

    {{-- Swipe cards --}}
    <main class="relative h-full md:h-[600px]    w-full md:w-96 m-auto">
                    ...
                    <section class="relative  h-96" x-data="{ activeSlide: 1, slides: @js($slides) }">
                        ...
                        <button draggable="true" :class="{ 'hidden': slides.length == 1 }"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="3" stroke="currentColor" class="w-6 h-6 text-white">
                        ...
                        <button @click="profile=false"
                            class="absolute -bottom-4 right-3 bg-meetcast p-3 hover:scale-110 transition-transform rounded-full max-w-fit max-h-fit text-white ">
                        ...
                        <div class="rounded-xl bg-green-200 h-24 px-4 py-2 max-w-fit flex gap-4 items-center">
                            ...
                            <div class="grid w-4/5">
                                ...
                                <span class="text-lg text-green-800 capitalize">
                                    {{ str_replace('_', ' ', $user->cast_goals?->value) }}</span>
                ...
                <div x-show="modalOpen" x-trap.inert.noscroll="modalOpen" x-transition:enter="ease-out duration-300"
                    ...
                    <main class="relative w-auto flex flex-col gap-y-9">
                        <div class="mx-auto flex flex-col gap-2 items-center justify-center">
                            {{-- meetcast logo --}}
                            <div class="mx-auto">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-14 h-14 text-violet-500" viewBox="0 0 16 16" id="tinder"><path fill="currentColor" stroke="none" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M3.588 13.923c-1.615-1.675-1.424-4.42.517-7.43.353-.548.718-1.045 1.14-1.551l.35-.421.034.376c.053.589.131.911.308 1.28.111.231.294.48.373.552.061.056.032.087.338-.072 2.016-1.125 2.224-2.961 2.11-4.541-.04-.464-.14-.98-.264-1.36C8.448.61 8.421.495 8.436.5c.014.005.265.248.558.54 2.796 2.79 4.308 5.713 4.505 8.703.061 3.427-1.849 5.254-4.629 5.643-2.373.375-4.012-.19-5.282-1.463z"/>
                                </svg>
                            </div>
                        ...
                        <div class="flex items-center gap-4 mx-auto">
                            <span>
                                <img src="https://source.unsplash.com/200x200?face-1" alt="" class="rounded-full h-32 w-32 ring ring-violet-500">
                            </span>
                            <span>
                                <img src="https://source.unsplash.com/200x200?face-2" alt="" class="rounded-full h-32 w-32 ring ring-violet-500">
                            </span>
                        </div>
                        {{--  Actions --}}
                        <div class="mx-auto flex flex-col gap-5">
                            <button wire:click="createConversation" class="bg-meetcast text-white font-bold items-center px-3 py-2 rounded-full">
                                Send a message
                            </button>
